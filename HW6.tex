...
In the following anwer, denote $n$ as total days to detect, $k$ as total target days of drought, $i\in [0,n]$ as $i$-th day, $p_i\in [0,1]$ as the probability of rain in $i$-th day. 
